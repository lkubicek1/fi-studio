...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        'relative flex w-full cursor-default items-start rounded-none px-2 py-2.5 text-xs leading-5 outline-hidden select-none focus:bg-accent focus:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50',
        className,
      )}
      {...props}
    >
      ...
      <SelectPrimitive.ItemText className="block min-w-0 flex-1 pr-6">{children}</SelectPrimitive.ItemText>
    </SelectPrimitive.Item>
  )
}
