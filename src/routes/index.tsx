      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between lg:gap-6">
        <div className="space-y-1.5">
          <div className="flex flex-wrap items-center gap-x-2.5 gap-y-1">
            <h2 className="text-lg leading-none tracking-[0.28em] text-primary">
          ...
          <p className="max-w-xl text-sm leading-5 text-muted-foreground">
            ...
            {activeCurve ? (<p className="max-w-xl text-sm leading-5 text-muted-foreground">
            Active Underyling Curve: {activeCurve.title}
          </p>) : null}

        </div>

        <div className="w-full max-w-sm border border-border bg-background px-4 py-3">
          <div className="mb-1.5 text-xs tracking-[0.18em] text-muted-foreground">
            SELECT CURVE
          </div>
          <CurveSelector />
        </div>
